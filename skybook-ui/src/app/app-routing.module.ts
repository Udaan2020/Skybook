...
const routes: Routes = [
  ...
  {path:'user/profile', component:ProfileComponent, canActivate:[UserAuthorizationService]},
  ...
  {
    path:"user/booking/ticket/:flightId/:pnr/:fare", component : TicketsComponent, canActivate:[UserAuthorizationService]
  },
